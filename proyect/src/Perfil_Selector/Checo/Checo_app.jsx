      ...
      <main className="container flex-grow-1 py-5" style={{ marginTop: '56px' }}>
        ...
        <section id="hobbies" className="resume-section mb-5">
          ...
          <div className="row hobbies-container">
            <div className="col-md-100 mb-10">
              <div className="card hobby-card shadow-sm col-12 mb-3">
            ...
            <div className="col-md-100 mb-10">
              <div className="card hobby-card shadow-smcol-12 mb-1">
                <iframe style={{ borderRadius: '12px', width: '100%', height: '360px' }} src="https://open.spotify.com/embed/playlist/4Anwih304LRzJnEZ2VYtjJ?utm_source=generator" frameBorder="0" allowFullScreen="100" allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture" loading="lazy"></iframe>
                <div className="card-body">
